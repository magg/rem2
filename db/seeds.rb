...
Story.create(:name => 'Tareas del Administrador', :status_id => '3', :descripcion => 'El sistema le permite al administrador permitir o negar el accesos a cierto ususarios', :functionpts => '112', :prioridad => 'alta', :usuario => 'Priscila', :comentarios => 'Desplegar la informacion de acuerdo a las prioridades')
...
Story.create(:name => 'Conexion con Bancos', :status_id => '2', :descripcion => 'Deben de existir conexiones con las DB de los bancos', :functionpts => '23', :prioridad => '5', :usuario => 'Stweie', :comentarios => 'Checar seguriad de Conexion')
# . . .
...
Task.create(:descripcion => 'Desplegar Acciones del Cajero', :estimadoinicial => '93', :status => '2', :story_id => '4', :student_id => '1')
...
# . . .
Student.create(:nombre => '1', :rol => 'Desarrollador')
Student.create(:nombre => '2', :rol => 'Analista')
Student.create(:nombre => '3', :rol => 'Arquitecto')
Student.create(:nombre => '4', :rol => 'Evaluador')
Student.create(:nombre => '5', :rol => 'Desarrollador')
# . . .
